...
import { submitApplication } from 'src/redux/slices/sendEnquiry';
...
// ----------------------------------------------------------------------
const BrandPopup = ({ closePopUp, ...props }) => {
  ...
  const eventSchema = Yup.object().shape({
    brandName: Yup.string().required(validationMessage.brandName),
    email: Yup.string()
    ...
    contactName: Yup.string().required(validationMessage.contactName),
      ...
      <Formik
        ...
        onSubmit={async (values) => {
          try {
            ...
            dispatch(getSuccess(apiMessage.merchantApplication));
            closePopUp();
          } catch (error) {
                  ...
                  {
                    {
                      1: (
                        <ButtonLoading
                          title={'Continue'}
                          handleClick={() =>
                            handleBackArrow(values && values.brandName ? 2 : 1)
                          }
                          container={
